...
class PassengerFileNumberBuilder implements CardBuilderInterface
{
    public const TYPE = 'TEXT';
    public const FIELD_TYPE = 'FILE_NUMBER';
    ...
    public function build(PassengerDto $passengerDto, PassengerTagDto $passengerTagDto, ElementDto $element, ImageInterface $image): void
    {
        ...
        $image->draw()->text($passengerDto->getFileNumber()->getFileNumber(), $font, new Point($element->getY(), $element->getX()), 0);
    }
}
