...
class PassengerFullNameBuilder implements CardBuilderInterface
{
    public const TYPE = 'TEXT';
    public const FIELD_TYPE = 'FULLNAME';
    ...
    public function build(PassengerDto $passengerDto, PassengerTagDto $passengerTagDto, ElementDto $element, ImageInterface $image): void
    {
        ...
        $image->draw()->text(sprintf('%s %s', $passengerDto->getLastName(), $passengerDto->getFirstName()), $font, new Point($element->getX(), $element->getY()), 0);
    }
}
