...
class SimpleImageBuilder implements CardBuilderInterface
{
    ...
    {
        return $element->getType() === static::TYPE && $element->getSourceType() == static::SOURCE_TYPE;
    }
    ...
    public function build(PassengerDto $passengerDto, PassengerTagDto $passengerTagDto, ElementDto $element, ImageInterface $image): void
    {
        ...
        $imageResource = $this->imagine->load($base64imageContent)->resize(new Box($element->getWidth(), $element->getHeight()));
