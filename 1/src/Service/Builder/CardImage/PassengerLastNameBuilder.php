...
class PassengerLastNameBuilder implements CardBuilderInterface
{
    public const TYPE = 'TEXT';
    public const FIELD_TYPE = 'LASTNAME';
    ...
    public function build(PassengerDto $passengerDto, PassengerTagDto $passengerTagDto, ElementDto $element, ImageInterface $image): void
    {
        ...
        $image->draw()->text($passengerDto->getLastName(), $font, new Point($element->getX(), $element->getY()), 0);
    }
}
