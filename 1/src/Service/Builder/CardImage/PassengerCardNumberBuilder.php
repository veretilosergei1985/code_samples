...
class PassengerCardNumberBuilder implements CardBuilderInterface
{
    public const TYPE = 'TEXT';
    public const FIELD_TYPE = 'CARD_NUMBER';
    ...
    public function build(PassengerDto $passengerDto, PassengerTagDto $passengerTagDto, ElementDto $element, ImageInterface $image): void
    {
        ...
        $image->draw()->text(sprintf('%s %s', $element->getTextContent(), $passengerTagDto->getId()), $font, new Point($element->getX(), $element->getY()), 0);
    }
}
